...
export default async function CharacterSheetPage({ params }: PageProps) {
  ...
  const statRows: { label: string; value: number; mod: number }[] = [
    { label: "STR", value: character.str, mod: derived.strMod },
    { label: "AGI", value: character.agi, mod: derived.agiMod },
    { label: "VIT", value: character.vit, mod: derived.vitMod },
    { label: "INT", value: character.intStat, mod: derived.intMod },
    { label: "SENSE", value: character.sense, mod: derived.senseMod }
  ];
